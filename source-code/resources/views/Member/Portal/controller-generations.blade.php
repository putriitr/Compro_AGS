...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Controller Generations</h1>
            <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{url('/portal')}}">Portal member</a></li>
                <li class="breadcrumb-item active text-primary">Controller Generations</li>
            </ol>
    </div>
</div>
<!-- Header End --><br><br>
                ...
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-img rounded-top border border-secondary" style="border-radius: 10px;">
                        ...
                        <div class="service-content-inner p-4" style="border-radius: 0 0 10px 10px;">
                            ...
                            @if($produk->controlGenerationsProduk->isNotEmpty())
                            @php $document = $produk->controlGenerationsProduk->first(); @endphp
